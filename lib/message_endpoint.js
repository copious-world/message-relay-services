...
class Server {
    ...
    //
    add_connection(client_name,sock) {
    ...
    init() {
        // ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
        if ( !(this.use_tls) ) {
            this.connection = net.createServer(this.onClientConnected_func);
        } else {
            const options = {
            ...
            this.connection = tls.createServer(options,this.onClientConnected_func);    
        }
