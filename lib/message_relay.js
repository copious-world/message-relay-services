                            ...
                            if (  (this.current_message._ps_op !== undefined ) && (this.current_message._ps_op !== 'pub') ) {
                                ...
                                if (  this.current_message._ps_op === 'sub'  ) {   // sub from pub/sub on this path.
                                    ...
                                    if ( topic ) {
                                        ...
                                        await shared_path_handler.subscribe(topic,this.current_message,listener)
                                        result = "OK"
                                    }
                                    ...
                                    if ( topic ) {
                                        ...
                                        await shared_path_handler.unsubscribe(topic,listener)   // remove this socket's handler
                                        delete topics[topic]
                                        result = "OK"    
                                    }
                                }
...
class Server extends Communicator {
    ...
    onClientConnected_func(sock) {
        ...
        this.add_message_handler(sock,client_name)
        //
        // 1. data
