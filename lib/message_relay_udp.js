...
class Client extends MRC {
    ...
    constructor(conf,wrapper) {
        // use the default response vector timeout if the conf does not specify one to use
        conf.response_vector = (typeof conf.response_vector === "string") ? conf.response_vector :  '../response-vector/resp_timeout'
